...
public enum ParticleEffect {
	...
	BLOCK_CRACK(
			"blockcrack", 37, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_DATA }),
	BLOCK_DUST(
	...
	private static boolean isColorCorrect(com.minehut.core.util.common.particles.ParticleEffect effect, ParticleColor color)
	{
